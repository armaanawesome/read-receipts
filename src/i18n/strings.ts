...
export const EN = {
  ...
  'setup.body': 'A few things to set. You can change any of them later in Settings.',
  'setup.languageSection': 'Language',
  'setup.languageNote': 'The app changes straight away. Cases that have not been translated yet stay in English.',
  'setup.feelSection': 'Sound and feel',
  ...
  'settings.legal.detail': 'Opens in your browser',
  'settings.legal.failed': 'Could not open the link. It is also in the app’s repository on GitHub.',
  'auth.continueGoogle': 'Continue with Google',
  'auth.continueApple': 'Continue with Apple',
  'auth.orEmail': 'or use an email address',
  'auth.provider.failed': 'Could not open the sign-in page. Check your connection and try again.',
  'auth.provider.unconfigured': 'That sign-in method is not switched on for this build yet. An email address works.',
  'auth.provider.cancelled': 'Sign-in was cancelled. Nothing changed.',
  'auth.provider.signedIn': 'Signed in. Your progress will sync from now on.',
  ...
  'signIn.age.over': 'I am 13 or older',
...
const ES: Catalogue = {
  ...
  'setup.title': 'Antes de empezar',
  'setup.body': 'Unos ajustes rápidos. Puedes cambiarlos después en Ajustes.',
  'setup.languageSection': 'Idioma',
  'setup.languageNote': 'La aplicación cambia al instante. Los casos que aún no están traducidos siguen en inglés.',
  'setup.feelSection': 'Sonido y sensación',
  'setup.done': 'Empezar a jugar',
  ...
  'settings.legal.detail': 'Se abre en tu navegador',
  'settings.legal.failed': 'No se pudo abrir el enlace. También está en el repositorio de la aplicación en GitHub.',
  'auth.continueGoogle': 'Continuar con Google',
  'auth.continueApple': 'Continuar con Apple',
  'auth.orEmail': 'o usa un correo electrónico',
  'auth.provider.failed': 'No se pudo abrir la página de inicio de sesión. Comprueba tu conexión e inténtalo de nuevo.',
  'auth.provider.unconfigured': 'Ese método de inicio de sesión aún no está activado en esta versión. Un correo electrónico sí funciona.',
  'auth.provider.cancelled': 'Se canceló el inicio de sesión. No ha cambiado nada.',
  'auth.provider.signedIn': 'Sesión iniciada. Tu progreso se sincronizará a partir de ahora.',
  ...
  'signIn.age.over': 'Tengo 13 años o más',
...
const FR: Catalogue = {
  ...
  'setup.body': 'Quelques réglages. Vous pourrez les changer plus tard dans les Réglages.',
  'setup.languageSection': 'Langue',
  'setup.languageNote': 'L’app change immédiatement. Les affaires pas encore traduites restent en anglais.',
  'setup.feelSection': 'Son et retours',
  'setup.done': 'Commencer',
  ...
  'settings.legal.section': 'Mentions légales',
  'settings.legal.privacy': 'Politique de confidentialité',
  'settings.legal.terms': 'Conditions d’utilisation',
  'settings.legal.detail': 'S’ouvre dans votre navigateur',
  'settings.legal.failed': 'Impossible d’ouvrir le lien. Il se trouve aussi dans le dépôt de l’app sur GitHub.',
  'auth.continueGoogle': 'Continuer avec Google',
  'auth.continueApple': 'Continuer avec Apple',
  'auth.orEmail': 'ou utiliser une adresse e-mail',
  'auth.provider.failed': 'Impossible d’ouvrir la page de connexion. Vérifiez votre connexion et réessayez.',
  'auth.provider.unconfigured': 'Cette méthode de connexion n’est pas encore activée dans cette version. Une adresse e-mail fonctionne.',
  'auth.provider.cancelled': 'Connexion annulée. Rien n’a changé.',
  'auth.provider.signedIn': 'Connecté. Votre progression sera synchronisée à partir de maintenant.',
  ...
  'signIn.age.over': 'J’ai 13 ans ou plus',
...
const DE: Catalogue = {
  ...
  'setup.body': 'Ein paar Einstellungen. Du kannst sie später jederzeit ändern.',
  'setup.languageSection': 'Sprache',
  'setup.languageNote': 'Die App wechselt sofort. Fälle, die noch nicht übersetzt sind, bleiben auf Englisch.',
  'setup.feelSection': 'Ton und Haptik',
  'setup.done': 'Los geht’s',
  ...
  'settings.legal.section': 'Rechtliches',
  'settings.legal.privacy': 'Datenschutzerklärung',
  'settings.legal.terms': 'Nutzungsbedingungen',
  'settings.legal.detail': 'Öffnet sich in deinem Browser',
  'settings.legal.failed': 'Der Link ließ sich nicht öffnen. Er steht auch im Repository der App auf GitHub.',
  'auth.continueGoogle': 'Weiter mit Google',
  'auth.continueApple': 'Weiter mit Apple',
  'auth.orEmail': 'oder mit einer E-Mail-Adresse',
  'auth.provider.failed': 'Die Anmeldeseite ließ sich nicht öffnen. Prüfe deine Verbindung und versuch es erneut.',
  'auth.provider.unconfigured': 'Diese Anmeldemethode ist in dieser Version noch nicht aktiviert. Mit einer E-Mail-Adresse geht es.',
  'auth.provider.cancelled': 'Anmeldung abgebrochen. Es hat sich nichts geändert.',
  'auth.provider.signedIn': 'Angemeldet. Dein Fortschritt wird ab jetzt synchronisiert.',
  ...
  'signIn.age.over': 'Ich bin 13 oder älter',
...
const PT_BR: Catalogue = {
  ...
  'setup.title': 'Antes de começar',
  'setup.body': 'Alguns ajustes rápidos. Dá para mudar depois nas Configurações.',
  'setup.languageSection': 'Idioma',
  'setup.languageNote': 'O app muda na hora. Os casos ainda não traduzidos continuam em inglês.',
  'setup.feelSection': 'Som e resposta',
  'setup.done': 'Começar a jogar',
  ...
  'settings.legal.section': 'Jurídico',
  'settings.legal.privacy': 'Política de privacidade',
  'settings.legal.terms': 'Termos de uso',
  'settings.legal.detail': 'Abre no seu navegador',
  'settings.legal.failed': 'Não foi possível abrir o link. Ele também está no repositório do app no GitHub.',
  'auth.continueGoogle': 'Continuar com Google',
  'auth.continueApple': 'Continuar com Apple',
  'auth.orEmail': 'ou usar um e-mail',
  'auth.provider.failed': 'Não foi possível abrir a página de login. Verifique sua conexão e tente de novo.',
  'auth.provider.unconfigured': 'Esse método de login ainda não está ativado nesta versão. Com e-mail funciona.',
  'auth.provider.cancelled': 'Login cancelado. Nada mudou.',
  'auth.provider.signedIn': 'Conectado. Seu progresso será sincronizado a partir de agora.',
  ...
  'signIn.age.over': 'Tenho 13 anos ou mais',
